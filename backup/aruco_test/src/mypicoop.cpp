...
mypic::mypic(ros::NodeHandle &n):n(n),it(n)
{
    goal_pub = n.advertise<geometry_msgs::Pose>("mygoal", 100);
    sub = it.subscribe("/camera/rgb/image_raw", 1, &mypic::imageCallback, this);
};
mypic::~mypic()
{
}
void mypic::imageCallback(const sensor_msgs::ImageConstPtr &msg)
{
